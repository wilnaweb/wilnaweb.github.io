---
title: Yduqs – Marketing Asset Automation
slug: /case-studies/yduqs-firefly
description: Automating marketing asset production with Adobe Experience Manager Assets, Adobe Firefly and Photoshop APIs for one of Brazil's largest education groups.
language: en
status: approved
...
Each campaign required the production of numerous communication assets with small but important variations, such as institutional branding, discount percentages, enrollment dates and promotional messages.
...
Marketing teams define a master communication template together with the campaign variables.

The platform automatically generates all required communication variations while preserving layout, branding and visual consistency.
...
Another challenge involved integrating Adobe Firefly and Photoshop APIs into an enterprise workflow that remained simple for marketing teams while supporting future campaign formats and automation requirements.
...
- Automated generation of marketing assets.
...
- Better operational efficiency for marketing teams.
