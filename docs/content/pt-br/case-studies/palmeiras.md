...
Fotos, vídeos e materiais institucionais estavam espalhados entre diferentes plataformas utilizadas por departamentos distintos, dificultando o controle, a governança e o compartilhamento das informações.
...
- Centralizar fotos, vídeos e documentos institucionais.
- Eliminar repositórios distribuídos em diferentes plataformas.
- Definir uma estratégia de governança para os ativos digitais.
- Controlar permissões de acesso entre departamentos.
...
- Centralização do acervo digital.
- Organização através de metadados.
- Estrutura de permissões por perfil de usuário.
- Processamento automático de imagens.
- Integração com Dynamic Media.
- APIs para distribuição de conteúdo.
- Integração com portais e sistemas internos.
...
Outro ponto importante foi estruturar um modelo de permissões capaz de atender tanto usuários internos quanto parceiros externos, como jornalistas e assessorias de imprensa.
...
- Integração entre AEM Assets e plataformas digitais.
- Automatização do processamento de imagens.
