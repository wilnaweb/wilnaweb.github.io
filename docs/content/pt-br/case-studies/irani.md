---
title: Irani – Plataforma de Relatórios Corporativos
slug: /case-studies/irani
description: Desenvolvimento de uma plataforma corporativa para publicação e gerenciamento de relatórios financeiros e de sustentabilidade.
language: pt-br
status: approved
...
- Divulgação de documentos corporativos.
- Controle de acesso para conteúdos públicos e restritos.
- Organização do histórico de documentos.
- Facilidade de atualização pelas equipes responsáveis.
...
A solução permitia que os responsáveis pelo conteúdo criassem páginas institucionais, anexassem documentos e gerenciassem todo o acervo corporativo através de uma interface simples.
...
- Plataforma centralizada para gestão de documentos corporativos.
- Organização dos relatórios financeiros e de sustentabilidade.
- Publicação simplificada de novos conteúdos.
- Suporte para conteúdos públicos e restritos.
- Melhor organização das informações corporativas.
