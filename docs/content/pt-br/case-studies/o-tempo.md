...
slug: /case-studies/o-tempo
description: Migração de uma das maiores plataformas de notícias do Brasil para Adobe Experience Manager as a Cloud Service.
language: pt-br
status: approved
...
Era necessário construir uma plataforma capaz de:

- Migrar aproximadamente dois milhões de conteúdos históricos.
- Preservar estrutura, categorias e metadados.
- Melhorar a experiência dos jornalistas e editores.
- Adaptar o Adobe Experience Manager ao fluxo editorial do jornal.
- Integrar serviços existentes.
...
- Nova arquitetura de publicação.
...
Outro ponto importante foi adaptar o Adobe Experience Manager ao fluxo de trabalho dos jornalistas, oferecendo uma experiência de edição simples, sem abrir mão da governança da plataforma.
...
- Migração de aproximadamente 2 milhões de conteúdos.
- Nova plataforma baseada em Adobe Experience Manager Cloud Service.
- Modernização do fluxo editorial.
- Centralização da gestão de conteúdo.
- Plataforma preparada para crescimento.
- Melhor desempenho e escalabilidade.
- Base sólida para evolução contínua do portal.
