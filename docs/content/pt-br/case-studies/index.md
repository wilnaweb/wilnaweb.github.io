...
navigation: Estudos de Caso
slug: /case-studies
description: Seleção de projetos corporativos envolvendo Adobe Experience Cloud, Arquitetura de Software, Plataformas Digitais e Liderança Técnica.
language: pt-br
status: approved
lastUpdated: 2026-08-05
heroEyebrow: Portfolio de Engenharia
heroSubtitle: Projetos reais, soluções aplicadas e resultados mensuráveis.
heroDescription: Uma seleção de implementações envolvendo Adobe Experience Cloud, arquitetura de software e evolução de plataformas digitais.
caseCardCtaLabel: Abrir estudo
---
...
<p class="expertise-meta-title">Cliente</p>

Grupo O TEMPO

<p class="expertise-meta-title">Segmento</p>

Mídia

<p class="expertise-meta-title">Atuação</p>

Arquiteto de Software • Tech Lead • Analista de Sistemas

<p class="expertise-meta-title">Tecnologias</p>

Adobe Experience Manager as a Cloud Service, Edge Delivery Services, Universal Editor, GraphQL, HTL, Sling Models, OSGi e Cloud Manager.
...
Adobe Experience Manager Assets, Dynamic Media, Adobe Brand Portal, APIs e OSGi.
...
Adobe Experience Manager Assets, Adobe Firefly, APIs do Photoshop e Inteligência Artificial Generativa.
...
Adobe Edge Delivery Services, Universal Editor e Adobe Experience Manager as a Cloud Service.
...
WordPress, Google Analytics, Google Ad Manager, Infraestrutura em Nuvem e CDN.
...
Apesar de atenderem segmentos diferentes, todos esses projetos compartilham os mesmos princípios de engenharia:
