---
title: Yduqs – Automação de Peças com IA
slug: /case-studies/yduqs-firefly
description: Automação da produção de peças de comunicação utilizando Adobe Experience Manager Assets, Adobe Firefly e APIs do Photoshop.
language: pt-br
status: approved
...
Cada campanha exigia a produção de dezenas ou até centenas de peças de comunicação, alterando informações como instituição de ensino, percentual de desconto, período de matrícula, logotipos e mensagens promocionais.
...
As alterações normalmente envolviam:
...
- Elementos visuais.
- Informações específicas de cada campanha.
...
A equipe de marketing define um modelo principal de comunicação e informa as variações desejadas para cada campanha.

A plataforma processa essas informações automaticamente, gerando todas as versões necessárias das peças de comunicação de forma padronizada e preservando a identidade visual de cada instituição.
...
- Estratégia de utilização de IA
...
Outro ponto importante foi integrar os recursos de Inteligência Artificial da Adobe ao processo de produção de campanhas sem aumentar a complexidade para os usuários de negócio.
...
- Automatização da geração de peças de comunicação.
- Redução significativa do trabalho manual.
- Maior velocidade na criação de campanhas.
- Padronização da comunicação visual.
- Melhor aproveitamento da equipe de marketing.
- Processo escalável para novas campanhas.
- Integração entre Adobe Experience Manager Assets, Firefly e Photoshop APIs.
