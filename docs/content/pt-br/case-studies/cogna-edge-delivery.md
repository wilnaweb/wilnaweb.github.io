---
title: Cogna – Plataforma Edge Delivery Services
slug: /case-studies/cogna-edge-delivery
description: Desenvolvimento de uma plataforma reutilizável de Landing Pages utilizando Adobe Edge Delivery Services.
language: pt-br
status: approved
...
A velocidade exigida pelas áreas de marketing tornava inviável desenvolver cada Landing Page como um projeto independente.
...
A solução precisava oferecer:

- Publicação rápida de Landing Pages.
- Padronização visual entre campanhas.
- Facilidade de edição de conteúdo.
- Reutilização de componentes.
- Alta performance.
- Governança da plataforma.
- Redução da dependência da equipe de desenvolvimento.
...
Ao invés de desenvolver uma nova Landing Page para cada campanha, as equipes passaram a montar páginas utilizando blocos já aprovados, garantindo consistência visual e reduzindo significativamente o tempo de entrega.
...
Era necessário permitir que novas Landing Pages fossem criadas rapidamente, mas garantindo que todas seguissem os padrões visuais, requisitos de acessibilidade e boas práticas de performance.
...
- Plataforma reutilizável para Landing Pages.
- Biblioteca de componentes padronizados.
- Redução significativa no tempo de criação de campanhas.
- Maior autonomia para as equipes de marketing.
- Padronização visual entre diferentes marcas.
- Melhor performance das páginas.
- Plataforma preparada para evolução contínua.
